...
evo_traj bag no_relocalize_good_results.bag /wheel_odom /rtabmap/odom /rtabmap/localization_pose /odometry/filtered --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xyz --align_origin #--align --n_to_align 2000
