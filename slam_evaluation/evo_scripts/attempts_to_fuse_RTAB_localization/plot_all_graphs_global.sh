...
#evo_traj bag map_fused_okay_res.bag /wheel_odom /rtabmap/odom /rtabmap/localization_pose /odometry/filtered --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xyz --align_origin #--align --n_to_align 2000
evo_traj bag map_fused_okay_res.bag /odometry/filtered /rtabmap/localization_pose --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xyz --align #--align --n_to_align 2000
