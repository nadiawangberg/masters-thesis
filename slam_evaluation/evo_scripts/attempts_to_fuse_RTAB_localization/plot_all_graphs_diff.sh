...
evo_traj bag diff_fuse_okay_res.bag /odometry/filtered /rtabmap/odom /wheel_odom --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xyz --align --align_origin #--align --n_to_align 2000
#evo_traj bag diff_fuse_okay_res.bag  /odometry/filtered /rtabmap/odom --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xyz --align_origin #--align --n_to_align 2000
