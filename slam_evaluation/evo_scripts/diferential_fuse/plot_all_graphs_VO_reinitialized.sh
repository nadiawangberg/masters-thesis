...
evo_traj bag diff_fused_VO_reinitialized.bag /wheel_odom /rtabmap/odom /odometry/filtered --ref /vicon/kobuki_vicon_link/kobuki_vicon_link --plot --plot_mode xy --align_origin --save_plot diff_fused_VO_reinit.pgf #--align --n_to_align 2000
