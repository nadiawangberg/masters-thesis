...
#evo_config set plot_fontfamily serif plot_fontscale 0.7 # 1.2
evo_config set plot_linewidth 1.0
evo_config set plot_fontscale 0.6
#evo_config set plot_fontscale 0.4
#evo_config set plot_reference_linestyle -


#Set the default figure size
evo_config set plot_figsize 10 9 #5 4.5
#evo_config set plot_figsize 12.5 11.25
